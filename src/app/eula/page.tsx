      ...
      <section className="py-12 sm:py-20 md:py-32">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-3xl mx-auto">
            <h1 className="text-4xl sm:text-5xl md:text-6xl font-light text-foreground mb-6">End User License Agreement</h1>
            <div className="space-y-6 text-muted-foreground leading-relaxed text-sm sm:text-base">
              <p className="text-muted-foreground/80">Last updated: January 2024</p>
              ...
              <h2 className="text-xl font-semibold text-foreground">3. License Grant</h2>
              <p>
              ...
              <h2 className="text-xl font-semibold text-foreground">4. Use Restrictions</h2>
              <ul className="list-disc pl-6 space-y-2">
              ...
              <h2 className="text-xl font-semibold text-foreground">5. Privacy and Data</h2>
              <p>
              ...
              <h2 className="text-xl font-semibold text-foreground">10. Updates and Modifications</h2>
              <p>
