        ...
        <div className="grid gap-10 lg:grid-cols-[minmax(0,3fr)_minmax(0,2fr)]">
          <div className="overflow-hidden rounded-2xl border border-gray-700 bg-black shadow-2xl">
            <div className="flex flex-wrap items-center justify-between gap-3 border-b border-gray-800 bg-gray-900/60 px-4 py-3">
              <div className="flex items-center gap-3">
                ...
                <span className="font-mono text-xs text-gray-400">wootz-browser</span>
              </div>
            ...
            <div className="space-y-5 overflow-x-auto px-4 py-6 font-mono text-sm text-gray-200 sm:px-6">
              <p className="text-xs text-gray-500">developer@enterprise:~$ # Explore the world&apos;s only open-source enterprise browser</p>
              {commands.map((command) => (
                <div key={command.cmd} className="space-y-2">
                  <div className="text-red-400">
                    <span className="text-red-500">$</span> {command.cmd}
                  </div>
                  <div className="space-y-1 border-l-2 border-red-800/60 bg-gray-900/40 px-4 py-3 text-xs text-gray-300">
          ...
          <div className="space-y-6">
            <div className="space-y-3">
              <Link href="https://github.com/wootzapp/wootz-browser" target="_blank" className="inline-flex items-center gap-2 text-sm font-medium text-red-400 hover:text-red-300">
                <GitBranch className="h-4 w-4" /> wootzapp/wootz-browser
              </Link>
            ...
            <div className="grid gap-4 rounded-xl border border-gray-700 bg-black/40 p-5 text-sm text-gray-200 sm:grid-cols-2">
              <div>
                <div className="font-semibold text-white">🔓 Open Source</div>
                <div className="text-gray-400">Audit every line</div>
              </div>
              <div>
              ...
              <div>
                ...
                <div className="text-gray-400">Android native</div>
              </div>
              <div>
                <div className="font-semibold text-white">🛡️ Zero Trust</div>
                <div className="text-gray-400">Built-in DLP</div>
              </div>
            </div>

            <div className="flex flex-col gap-3 sm:flex-row">
              <Link href="https://github.com/wootzapp/wootz-browser" target="_blank" className="flex-1">
                <Button className="w-full justify-center border border-red-500 bg-red-500 text-white hover:bg-red-600">
              ...
              <Link href="https://github.com/wootzapp/wootz-browser/fork" target="_blank" className="flex-1">
                <Button variant="outline" className="w-full justify-center border border-gray-600 text-white hover:bg-gray-800">
